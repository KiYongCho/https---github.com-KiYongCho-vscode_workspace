...
const hong = new Student('홍길동', 20, ['골프', '스키'], 100, 100, 100);
const kang = new Student('강감찬', 30, ['독서', '낮잠'], 90, 90, 90);
const lee = new Student('이순신', 40, ['게임', '바둑'], 80, 80, 80);

console.log(`총 ${Student.getStudentCount()}명의 학생 정보입니다.`);
hong.printStudentInfo();
kang.printStudentInfo();
